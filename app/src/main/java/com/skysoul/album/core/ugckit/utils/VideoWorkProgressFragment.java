...
import com.skysoul.album.view.NumberProgressBar;
...
public class VideoWorkProgressFragment extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(_AlbumUtils.getResId(getActivity(), "ALBUM_UGCKitConfirmDialogStyle", "style"),
                _AlbumUtils.getResId(getActivity(), "ALBUM_UGCKitDialogFragmentStyle", "style"));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mProgressLoading.setReachedBarColor(Color.parseColor("#FF584C"));
        mProgressLoading.setProgressTextSize(mProgressLoading.sp2px(10));
        mProgressLoading.setProgressTextColor(Color.parseColor("#FF584C"));
        mProgressLoading.setReachedBarHeight(_AlbumUtils.dp2px(1.5f));
        mProgressLoading.setUnreachedBarHeight(_AlbumUtils.dp2px(0.75f));
