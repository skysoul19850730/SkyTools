...
//import com.skysoul.album.core.ugckit.effect.DraftEditer;
//import com.skysoul.album.core.ugckit.effect.EffectEditer;
//
...
// * <p>
// * 需要注意：
// * 完成一次视频编辑后，请务必调用{@link com.skysoul.album.core.ugckit.VideoEditerSDK#clear()}晴空相关的一些配置
// */
...
//    }
//
//    public void constructVideoInfo(TXVideoEditConstants.TXVideoInfo videoInfo, long duration) {
//        videoInfo.width = 100;
...
//     */
//    public void initThumbnailList(int thumbCount, int interval, TXVideoEditer.TXThumbnailListener listener) {
//        if (interval == 0) {
