...
public class RangeSlider extends ViewGroup {
    ...
    public RangeSlider( Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBgPaint = new Paint();
        mBgPaint.setColor(DEFAULT_MASK_BACKGROUND);
        ...
        mLeftThumb = new ThumbView(context, mThumbWidth, new ColorDrawable(DEFAULT_LINE_COLOR));
        mRightThumb = new ThumbView(context, mThumbWidth, new ColorDrawable(DEFAULT_LINE_COLOR));
        setTickCount(DEFAULT_TICK_END);
        setRangeIndex(DEFAULT_TICK_START, mTickCount);
