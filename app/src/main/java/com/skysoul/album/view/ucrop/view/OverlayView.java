...
public class OverlayView extends View {
    ...
    private boolean mCircleDimmedLayer = DEFAULT_CIRCLE_DIMMED_LAYER;
    ...
    {
        mTouchPointThreshold = _AlbumUtils.dp2px(30);
        mCropRectMinSize = _AlbumUtils.dp2px(100);
        mCropRectCornerTouchAreaLineLength = _AlbumUtils.dp2px(10);
    }
     ...
     */
    public void setCropGridCornerColor(int color) {
...
//        }
    ...
    private void initCropFrameStyle() {
        int cropFrameStrokeSize = _AlbumUtils.dp2px(1);
    ...
    private void initCropGridStyle() {
        int cropGridStrokeSize = _AlbumUtils.dp2px(1);
