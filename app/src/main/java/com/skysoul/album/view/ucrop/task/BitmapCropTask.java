...
import com.skysoul.album.view.ucrop.util.FileUtils;
import com.skysoul.album.view.ucrop.util.ImageHeaderParser;
 ...
 */
public class BitmapCropTask extends InnerAsyncTask<Void, Void, Throwable> {
    ...
    public BitmapCropTask(Context context, Bitmap viewBitmap, ImageState imageState, CropParameters cropParameters,
...
//            FileUtils.copyFile(mImageInputPath, mImageOutputPath);
    ...
    private void saveImage(Bitmap croppedBitmap) {
        ...
        if (mCropCallback != null) {
            if (t == null) {
                if (isCrop) {
                    ...
                    mCropCallback.onBitmapCropped(null, 0, 0, -1, -1);
                }
            } else {
