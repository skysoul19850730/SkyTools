...
import com.skysoul.album.view.ucrop.util.FastBitmapDrawable;
...
public class TransformImageView extends ImageView {
     ...
     * Be sure to call it before {@link #setImageURI(android.net.Uri)} or other image setters.
     *
     ...
     * @param valueIndex - index of needed value. See {@link android.graphics.Matrix#MSCALE_X} and others.
