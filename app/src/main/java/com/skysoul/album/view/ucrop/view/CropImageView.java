...
import com.skysoul.album.view.ucrop.model.CropParameters;
import com.skysoul.album.view.ucrop.model.ImageState;
import com.skysoul.album.view.ucrop.task.BitmapCropTask;
import com.skysoul.album.view.ucrop.util.CubicEasing;
import com.skysoul.album.view.ucrop.util.InnerAsyncTask;
import com.skysoul.album.view.ucrop.util.RectUtils;
...
public class CropImageView extends TransformImageView {
     ...
     */
    public void cropAndSaveImage(Bitmap.CompressFormat compressFormat, int compressQuality,
        ...
        new BitmapCropTask(getContext(), getViewBitmap(), imageState, cropParameters, cropCallback)
                .executeOnExecutor(InnerAsyncTask.THREAD_POOL_EXECUTOR);
    }
     ...
     * {@link com.skysoul.album.view.ucrop.view.CropImageView.WrapCropBoundsRunnable} which animates image.
    ...
    protected void processStyledAttributes() {
        float targetAspectRatioX = DEFAULT_ASPECT_RATIO;
        float targetAspectRatioY = DEFAULT_ASPECT_RATIO;
     ...
     * or when certain conditions inside {@link com.skysoul.album.view.ucrop.view.CropImageView.WrapCropBoundsRunnable#run()} method are triggered.
     */
     ...
     * Given values are interpolated during the animation time.
     * Runnable can be terminated either vie {@link #cancelAllAnimations()} method
     * or when certain conditions inside {@link com.skysoul.album.view.ucrop.view.CropImageView.ZoomImageToPosition#run()} method are triggered.
     */
